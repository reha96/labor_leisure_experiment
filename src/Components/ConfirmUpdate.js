...
const ConfirmUpdate = (props) => {
  ...
  return (
    <div className="timer">
<p className="HomePage_p">You spend <strong>{divi}%</strong> of your time on <strong>Typing</strong> and <strong>{100 - divi}%</strong> of your time on <strong>Watching Videos</strong>:</p>
